...
export const getThisMonday = (calendar: DayData[], indexOfToday: number, today: DayData) => {
...
export const getLastMonday = (calendar: DayData[], indexOfToday: number, today: DayData) => {
